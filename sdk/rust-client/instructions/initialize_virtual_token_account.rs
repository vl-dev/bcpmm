...
pub const INITIALIZE_VIRTUAL_TOKEN_ACCOUNT_DISCRIMINATOR: [u8; 8] = [188, 135, 151, 109, 183, 234, 240, 3];

/// Accounts.
#[derive(Debug)]
pub struct InitializeVirtualTokenAccount {
...
impl InitializeVirtualTokenAccount {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let data = InitializeVirtualTokenAccountInstructionData::new().try_to_vec().unwrap();
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct InitializeVirtualTokenAccountInstructionData {
            discriminator: [u8; 8],
      }

impl InitializeVirtualTokenAccountInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [188, 135, 151, 109, 183, 234, 240, 3],
                  }
  }
...
impl Default for InitializeVirtualTokenAccountInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
/// Instruction builder for `InitializeVirtualTokenAccount`.
///
/// ### Accounts:
///
...
pub struct InitializeVirtualTokenAccountBuilder {
...
impl InitializeVirtualTokenAccountBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = InitializeVirtualTokenAccount {
  ...
  /// `initialize_virtual_token_account` CPI accounts.
  pub struct InitializeVirtualTokenAccountCpiAccounts<'a, 'b> {
...
/// `initialize_virtual_token_account` CPI instruction.
pub struct InitializeVirtualTokenAccountCpi<'a, 'b> {
...
impl<'a, 'b> InitializeVirtualTokenAccountCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: InitializeVirtualTokenAccountCpiAccounts<'a, 'b>,
          ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `InitializeVirtualTokenAccount` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` payer
          ...
          ///   4. `[]` system_program
#[derive(Clone, Debug)]
pub struct InitializeVirtualTokenAccountCpiBuilder<'a, 'b> {
  instruction: Box<InitializeVirtualTokenAccountCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> InitializeVirtualTokenAccountCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(InitializeVirtualTokenAccountCpiBuilderInstruction {
      __program: program,
              payer: None,
              owner: None,
  ...
  #[allow(clippy::vec_init_then_push)]
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = InitializeVirtualTokenAccountCpi {
...
#[derive(Clone, Debug)]
struct InitializeVirtualTokenAccountCpiBuilderInstruction<'a, 'b> {

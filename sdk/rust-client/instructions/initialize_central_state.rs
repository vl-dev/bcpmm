...
impl InitializeCentralState {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = InitializeCentralStateInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl InitializeCentralStateBuilder {
    ...
    #[inline(always)]
    pub fn burn_reset_time_of_day_seconds(
        &mut self,
    ...
    #[inline(always)]
    pub fn buyback_fee_bp(&mut self, buyback_fee_bp: u16) -> &mut Self {
        self.buyback_fee_bp = Some(buyback_fee_bp);
        self
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = InitializeCentralStateInstructionArgs {
            ...
            max_user_daily_burn_count: self
                .max_user_daily_burn_count
                .clone()
                .expect("max_user_daily_burn_count is not set"),
            max_creator_daily_burn_count: self
                .max_creator_daily_burn_count
                .clone()
                .expect("max_creator_daily_burn_count is not set"),
            user_burn_bp_x100: self
                .user_burn_bp_x100
                .clone()
                .expect("user_burn_bp_x100 is not set"),
            creator_burn_bp_x100: self
                .creator_burn_bp_x100
                .clone()
                .expect("creator_burn_bp_x100 is not set"),
            burn_reset_time_of_day_seconds: self
                .burn_reset_time_of_day_seconds
                .clone()
                .expect("burn_reset_time_of_day_seconds is not set"),
            creator_fee_bp: self
                .creator_fee_bp
                .clone()
                .expect("creator_fee_bp is not set"),
            buyback_fee_bp: self
                .buyback_fee_bp
                .clone()
                .expect("buyback_fee_bp is not set"),
            platform_fee_bp: self
                .platform_fee_bp
                .clone()
                .expect("platform_fee_bp is not set"),
        };
...
impl<'a, 'b> InitializeCentralStateCpiBuilder<'a, 'b> {
    ...
    #[inline(always)]
    pub fn buyback_fee_bp(&mut self, buyback_fee_bp: u16) -> &mut Self {
        self.instruction.buyback_fee_bp = Some(buyback_fee_bp);
        self
    }
    #[inline(always)]
    pub fn platform_fee_bp(&mut self, platform_fee_bp: u16) -> &mut Self {
